 ...
 */
export const AUTH_BUTTON_BASE_CLASSES = "btn w-full h-[55px] text-brand-button rounded-2xl border-none transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-orange focus:ring-offset-2";
