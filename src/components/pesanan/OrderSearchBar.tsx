...
import { useOrderSearchQuery, useSetOrderSearchQuery } from '@/stores/orderStore';

export default function OrderSearchBar() {
  const searchQuery = useOrderSearchQuery();
  const setSearchQuery = useSetOrderSearchQuery();
  ...
  return (
    <div className="relative w-full">
      ...
      <input
        type="text"
        placeholder="Cari pesanan (ID, pelanggan, produk, alamat)..."
        value={searchQuery}
